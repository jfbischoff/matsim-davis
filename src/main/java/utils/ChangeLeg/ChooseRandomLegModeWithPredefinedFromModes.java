 ...
 */
public class ChooseRandomLegModeWithPredefinedFromModes implements PlanAlgorithm {
	 ...
	 * @see MatsimRandom
	 */
	public ChooseRandomLegModeWithPredefinedFromModes(final String[] possibleModes, final String[]  allowedFromModes, final Random rng) {
