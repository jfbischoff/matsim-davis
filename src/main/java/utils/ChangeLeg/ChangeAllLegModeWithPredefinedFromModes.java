 ...
 */
public class ChangeAllLegModeWithPredefinedFromModes extends AbstractMultithreadedModule {

	private String[] availableModes = new String[] { TransportMode.car, TransportMode.pt };
	private boolean ignoreCarAvailability = true;

	public ChangeAllLegModeWithPredefinedFromModes(final GlobalConfigGroup globalConfigGroup, ChangeModeConfigGroup changeLegModeConfigGroup) {
	...
	public ChangeAllLegModeWithPredefinedFromModes(final int nOfThreads, final String[] modes, final boolean ignoreCarAvailabilty) {
		super(nOfThreads);
	...
	public PlanAlgorithm getPlanAlgoInstance() {
		ChooseRandomLegModeWithPredefinedFromModes algo = new ChooseRandomLegModeWithPredefinedFromModes(this.availableModes, this.availableModes, MatsimRandom.getLocalInstance());
