...
public class CreatePlansFile {
	...
	public static void main(String[] args) {
		...
		new CreatePlansFile().run("C:/Users/anmol331/Desktop/scenario/network_parkingCost.xml.gz", "C:/Users/anmol331/Desktop/Scenario_3/tripsToStations.csv","C:/Users/anmol331/Desktop/Scenario_3/drt_plans.xml");
	}
	...
	private void readCSVToPopulation(String inputTriptable) {
		...
		new TabularFileParser().parse(tbc, new TabularFileHandler() {
			...
			public void startRow(String[] rw) {
				...
				double coordX = Double.parseDouble(rw[18]);
				double coordY = Double.parseDouble(rw[19]);
				Coord destinationCoord = ct.transform(new Coord(coordX,coordY));
